...
const V4_COMPANY_OS_PREP = [
  {
    title: 'ACL / Qwen Cloud handoff still open',
    tags: ['P0', 'brief due', 'scripts overdue'],
    points: [
      'Annika sent the updated Alibaba answer doc, the recorded online-interview assets, and confirmation that ACL coordination should stay inside the current email chain.',
      'Robert already approved keeping ACL logistics in email, and the on-site ACL window still sits on Sunday, July 5 from 1:00 PM to 2:00 PM PDT for the paper authors plus Qoder.',
      'Asher owns the 60-second Robert prep from the Qwen Cloud answers and recording, the overdue first draft batch for the 8 scripts, and the ticket / reimbursement reconciliation trail.',
      'Helpful prep material is not final sign-off. Keep scripts, reimbursement proof, and final source files visible in-thread.',
    ],
  },
  {
    title: 'Cline / invoice before June 29 quote post',
    tags: ['P0', 'invoice now', 'launch today'],
    points: [
      'Pratham accepted the revised $2,195 quote-post package with engagement and asked for the invoice, with the requested go-live time set for Sunday, June 29 at 8:45 AM PT.',
      'The thread still lacks the sent invoice, the payment proof, and the final live source post Robert would actually be quoting.',
      'Asher owns the invoice link, payment capture, and the 60-second Robert brief once the canonical live tweet exists.',
      'A yes plus billing details is not booked execution until the invoice trail, payment proof, and source link are all in-thread.',
    ],
  },
  {
    title: 'ACTI / June 30 quote launch prep',
    tags: ['P0', 'paid', 'brief tonight'],
    points: [
      'AK fixed the official announcement for Tuesday, June 30 at 7:30 AM PT and already sent the confidential launch copy, video, and quote direction.',
      'Payment was already confirmed earlier in the thread, but Robert still needs a 60-second prep brief and the real live tweet URL once the post is up.',
      'Asher owns the launch-morning source-link handoff, the final approval loop, and the short Robert brief tonight.',
      'Confidential launch drafts and videos are prep material only. They do not replace the canonical live source post.',
    ],
  },
  {
    title: 'Eastworlds / June 29 live-link closeout',
    tags: ['P1', 'timing promised', 'closeout gap'],
    points: [
      'Sean reverted to the original Pemba draft, asked for Monday, June 29 at 8:00 AM PT, and followed up overnight asking whether the post was still on track.',
      'Asher already replied that the post would be up in the morning, so the thread now needs the actual Robert live link back in email as the closeout artifact.',
      'Asher owns the final live-link capture and any cleanup if the promised timing slips.',
      'Once timing is promised externally, the lane stays open until the final Robert URL is in-thread.',
    ],
  },
  {
    title: 'Viture / July 1 kickoff still needs receipt',
    tags: ['P1', 'payment initiated', 'kickoff inputs missing'],
    points: [
      'Leo confirmed that Viture started the payment process and July 1 still stands as the month-one kickoff target.',
      'What is still missing is the actual receipt plus the initial campaign priorities, key dates, and launch roadmap for the first phase.',
      'Asher owns the receipt chase and kickoff-pack collection before Robert time gets allocated.',
      '“Finance is processing it” is not the same as receipt-in-thread.',
    ],
  },
  {
    ...
    points: [
      'Julius resurfaced on Sunday, June 29 and said Sintra added 100 credits to AsherUnaligned@gmail.com so the Helper-builder campaign can be finished.',
      'The lane is unblocked enough to retest, but content still cannot move until someone proves the product works end-to-end on the restored credits.',
...
const V4_COMPANY_OS_WAITING = [
  {
    title: 'Riverside / press-release hold still external',
    tags: ['watch', 'launch date missing', 'client hold'],
    points: [
      'Jay asked for the exact Riverside launch date on Sunday, June 29, but Savion still has not sent the final green light, press-release wording, or publish date.',
      'The waiting state is unchanged: no publishing until Riverside sends exact launch timing, official language, and approval.',
      'Keep Robert out of execution until the client’s launch controls are back in-thread.',
      'A follow-up asking for the date does not equal launch clearance.',
    ],
  },
  {
    title: 'OMANE / second-leg receipt still missing',
    tags: ['watch', 'payment proof', 'June 30 closeout'],
    points: [
      'Ori acknowledged the receipt chase, and Asher re-added the Viktor invoice into Fillout, but the second-leg wire receipt still has not landed back in the email thread.',
      'The June 30 Viktor posts also still need the final live links logged cleanly once they are up.',
      'Keep this in watch until the receipt and the remaining closeout links are all in-thread.',
      'A form re-upload is not settlement proof.',
    ],
  },
  {
    title: 'Atomik / old payment proof vs new Clodo ask',
    tags: ['watch', 'receipt promised', 'split lane'],
    points: [
      'Sam forwarded the Wise payment notice, and Aviral said the Clodo payment already cleared and promised the receipt before go-live.',
      'What is still missing is the actual receipt in-thread plus the final Robert live-link cleanup for the prior Atomik execution.',
      'Keep the old payment-proof cleanup separate from the new Clodo scope and launch discussion.',
      'External claims of payment are not closed finance until the receipt lives on the thread.',
    ],
  },
  {
    ...
    points: [
      'Stella only confirmed interest in a consecutive Robert X-post plan and never supplied the missing count, cadence, launch dates, or format split.',
      'The lane is still too vague to package cleanly, and the accidental one-character send from Asher did not move scope forward.',
