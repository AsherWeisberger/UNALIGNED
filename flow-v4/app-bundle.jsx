...
const V4_COMPANY_OS_RULES = [
  'Asher owns replies, invoice links, payment-proof capture, final live links, scheduling cleanup, tax-doc follow-through, and every 60-second Robert brief. Sam escalates. Robert executes only after the lane is clean.',
