...
const V4_COMPANY_OS_PREP = [
  {
    ...
    tags: ['P0', 'June 9-10 complete', 'archive cleanly'],
    points: [
      'Both Airtap posts are now live: June 9, 2026 at https://x.com/Scobleizer/status/2064410988187938978?s=20 and June 10, 2026 at https://x.com/Scobleizer/status/2064788508401914209?s=20.',
      'Zoe confirmed receipt in-thread on June 10, 2026 and only replied "thank you" again on June 11, 2026.',
      'No more creative work is owed unless Flot.AI asks for reporting, payment cleanup, or another booked slot.',
      'Keep this in prep only long enough to confirm nothing financial is still open, then move it fully out.',
    ],
  },
  {
    ...
    points: [
      'Asher sent Annika the revised 8-piece Alibaba Cloud framework on June 9, 2026, focused on papers plus booth coverage after ACL.',
      'That content reply does not solve the money problem: Robert already purchased the $1,200 ticket and hotel/travel reimbursement is still not locked in writing.',
      'Next Asher move is not more strategy unless Alibaba answers. The real follow-up is written confirmation on ticket coverage, travel coverage, and any remaining approvals.',
  ...
  },
  {
    ...
    points: [
      'Eric confirmed payment on June 9, 2026 for the one-time retweet package and said the live link would come the next morning.',
      'Asher\'s last note says "Waiting on your live link." No live URL is visible yet in-thread.',
      'Asher owns the chase: confirm the payment landed cleanly, get the live launch post URL, and lock Robert\'s actual repost timing.',
      'Do not let this drift into a second campaign conversation until the first paid deliverable is executed and linked.',
    ],
  },
  {
    ...
    points: [
      'Lumina replied on June 7, 2026 that the official site is now the live 3.0 experience and there is no separate demo environment anymore.',
      'Asher\'s response on June 10, 2026 makes clear Robert still only sees the blank collaborator canvas and still has nothing meaningful to test.',
      'The only valid next move is an unblock ask for the exact usable path or account state needed for Robert to see the real product.',
      'Do not convert deck copy into a Robert brief while the product itself remains inaccessible.',
    ],
  },
  {
    title: 'Lead Replies / Asher Queue',
    tags: ['P0', 'reply batch', 'qualify fast'],
    points: [
      'Kevin at Inbox followed up again on June 10, 2026 asking for recent collaboration examples before he decides on a campaign.',
      'ShowMedia replied on June 10, 2026 with an onboarding form request for payment/tax details plus a preference for a faster backchannel.',
      'Eastworlds came in on June 10, 2026 with the Chimborazo robot-climb story and asked how Unaligned can amplify it, but still owes exact scope, deliverables, and timing.',
      'Asher should keep all three threads on his side until scope, budget, deliverable, and timing are clean enough for Robert or Sam to matter.',
    ],
  },
];
...
const V4_COMPANY_OS_WAITING = [
  ...
  },
  {
    ...
    tags: ['watch', 'pricing pushback', 'needs counter'],
    points: [
      'Ori pushed back on the LinkedIn-heavy bundle pricing on June 3, 2026 and asked for a better long-term structure.',
      'Sam said he and Asher would huddle and get back to him, but there is still no follow-up counter visible in-thread.',
      'This is a commercial wait, not a Robert execution item.',
      'Do not brief Robert until pricing, scope, and approval path are settled.',
    ],
  },
  {
    ...
    points: [
      'Savion previously said he would come back with dates and could swap another Riverside executive if Nadav slips.',
      'There is still no concrete interview slot or confirmed spokesperson in the current inbox state.',
      'Nothing new is owed until an actual date lands.',
      'If they reply with timing, move it back into action immediately.',
    ],
  },
  {
    title: 'Do-Not-Touch / Hard Pass',
    tags: ['EezyCollab', 'Olivia', 'keep closed'],
    points: [
      'Sam called the EezyCollab beta-test structure a hard pass and Robert already drafted the decline.',
      'An external reply about possible upfront payment does not reopen the internal no by itself.',
      'Sam separately killed the Olivia thread as a waste of cycles.',
      'Do not negotiate, brief Robert, or spend more reply energy here unless Sam or Robert explicitly reopens either thread.',
    ],
  },
];
...
const V4_COMPANY_OS_RULES = [
  ...
  'Keep new lead threads in email until company, product, deliverable, budget, and timing are real. Generic interest, onboarding asks, and story pitches are not Robert briefs.',
