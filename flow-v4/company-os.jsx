...
const V4_COMPANY_OS_PREP = [
  {
    ...
    tags: ['P0', 'invoice sent', 'launch link owed'],
    points: [
      'Judy accepted the $1,895 Tier 2 quote repost on June 13, 2026, and Asher already sent the live Stripe invoice link back into the thread that same day.',
      'The work left is pure closeout: payment proof, the official launch post URL, posting window, tags/CTA, and any launch notes for the June 16 run.',
      'Do not tee up Robert until both the payment proof and official source post are visible in-thread.',
      'If they still want the Tier 3 custom post after launch, treat it as a second paid campaign, not a quiet add-on.',
    ],
  },
  {
    title: 'Venice AI / Jay A',
    tags: ['P0', 'date proposed', 'calendar confirm'],
    points: [
      'Jay clarified on June 9, 2026 that Venice AI is a separate Erik Voorhees interview, not the stalled Riverside cleanup thread.',
      'Asher offered June 22, 2026 after 1:00 PM PT, and Jay said on June 13 he is checking whether that date works for the Venice team.',
      'This stays on Asher until there is one explicit yes, one exact time, and one accepted calendar invite.',
      'A soft hold is not a booking. No Robert prep exists until the slot is actually confirmed.',
    ],
  },
  {
    title: 'Perceptron / Agentic Detection',
    tags: ['P0', 'paid', 'proof capture'],
    points: [
      'Eric confirmed payment on June 9, 2026 and then sent the launch copy preview plus notice that the post was going live within hours on June 10.',
      'The thread still lacks the final Perceptron launch URL and Robert\'s actual repost URL, so the paid record is not clean yet.',
      'Asher now owns artifact capture only: source post, Robert repost, and any proof needed to close the invoice trail.',
      'Do not open the robotics follow-on until the first paid execution is fully linked and archived.',
    ],
  },
  {
    title: 'Cutback / Selects',
    tags: ['P0', 'full prepay only', 'monday hold'],
    points: [
      'Wonjae moved the Selects quote repost to Monday at 9:00 AM ET and tried to reset terms to 40/60 because of prior delivery issues on their side.',
      'Asher held the line on June 11, 2026: no split payments, full prepay only, draft approval before posting, and the Stripe invoice link is already in-thread.',
      'The only useful next move is a paid invoice or an explicit no.',
      'No Robert draft work starts until payment policy is accepted and the official launch post/video are released into the thread.',
    ],
  },
  {
    title: 'Skillshare / Michael Turner',
    tags: ['P0', 'rate accepted', 'billing details owed'],
    points: [
      'Michael pitched a 60-second Skillshare integration with 42% rev share, and Asher answered on June 8, 2026 with the $1,995 rate for the mention.',
      'By June 11, Asher confirmed the verification email landed and told Michael to open the catalog so Robert can browse.',
      'The missing piece is still billing: invoice details, payment path, and the actual content timing.',
      'Until that lands, this is Asher-side commercial follow-up, not a Robert brief.',
    ],
  },
  {
    title: 'KroWork / EezyCollab',
    tags: ['P1', 'rate reset', 'terms sent'],
    points: [
      'Meilinda came back with a real urgency push for June 15, and Asher answered on June 12, 2026 with the actual terms: $1,895 for the repost or $3,995 if they also want the two-week pin.',
      'The deal is reopened, but only on Unaligned terms and only if they send the official post, timing, product access, and prepay confirmation.',
      'Asher owns the next touch only if the brand accepts the reset and wants to proceed cleanly.',
...
const V4_COMPANY_OS_WAITING = [
  ...
  },
  {
    ...
    points: [
      ...
      'Asher sent the revised doc back the same day, and there is still no newer brand response in-thread.',
  ...
  },
  {
    ...
    points: [
      'Asher locked Andrew into Wednesday, June 17, 2026 at 11:00 AM PT and sent the Meet details, then Andrew asked to shorten it to 30 minutes because he has another meeting at 11:30.',
      'Asher replied that he would adjust it, but the thread still does not show the corrected invite.',
      'Keep it in waiting until the calendar reflects the actual 30-minute block.',
  ...
  },
  {
    ...
    points: [
      ...
      'Asher also asked Judy to send the actual content shape and package choice, but there is still no test readout, no selected deliverable, and no locked date.',
...
const V4_COMPANY_OS_RULES = [
  ...
  'If an invoice link is already in-thread, stop re-explaining the package and chase only three things: payment proof, final asset, and posting window.',
