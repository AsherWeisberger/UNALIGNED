...
const V4_COMPANY_OS_PREP = [
  ...
  },
  {
    ...
    points: [
      'Lumina provided assets, the correct X handle @_ahacreator, and said scobleizer@gmail.com was whitelisted on June 2, 2026.',
      'Asher replied again on June 5 that Robert still does not see the demo environment, so the blocker is now product access, not creative direction.',
      'Asher owes one clean unblock loop with Lumina, then a 60-second Robert brief only after Robert can actually test the product.',
      'Do not push Robert to post from the brief alone if the demo environment is still missing.',
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      'The invoice is already out, but the thread turned risky on June 5, 2026 when Robert proposed a no-disclosure angle and Jeddi replied yes.',
  ...
  },
  {
    ...
    points: [
      'Ori sent the live Nitrosend launch instructions on June 3, 2026 and Asher replied in-thread asking for the receipt as soon as payment is made.',
      'The operational task is payment-proof capture, not more creative work.',
  ...
  },
  {
    ...
    points: [
      'The Friday, June 5, 2026 meeting broke down, and Michael asked Robert to catch up again on Monday.',
      'Robert already drafted the correct reset: no extra catch-up call, send any concrete paid campaign or sponsorship specifics through Asher and Sam.',
      'Asher should treat this as an intake-routing item, not another discovery meeting to protect Robert calendar time.',
      'Do not put Robert back on a live call here unless scope, budget, and deliverable are concrete first.',
    ],
  },
  {
    title: 'CL Coding Collaboration',
    tags: ['P1', 'fresh intro', 'scope needed'],
    points: [
      'Robert handed CL Coding to Asher late on June 5, 2026, and Asher replied with package framing and intro context the same night.',
      'The next move is on their side: campaign goals, platform, deliverable shape, timing, and budget.',
      'Keep Robert out until this becomes an actual package or execution ask.',
...
const V4_COMPANY_OS_WAITING = [
  ...
  },
  {
    ...
    tags: ['EezyCollab', 'Olivia', 'Sam call'],
    points: [
      'Sam said on June 5, 2026, "we\'re not working for these guys nor have time for their testing. hard pass" on EezyCollab.',
...
const V4_COMPANY_OS_RULES = [
  ...
  'If the product requires Robert testing, no execution brief exists until access actually works.',
