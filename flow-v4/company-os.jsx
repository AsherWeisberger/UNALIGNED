...
const V4_COMPANY_OS_WAITING = [
  ...
  {
    title: 'Exploratory Inbound / Standpoint + Base and Partner',
    tags: ['watch', 'context first', 'not Robert-ready'],
    points: [
      'Standpoint AI now has real founder-interest momentum after Baek replied on June 14, 2026, but the thread is still an exploratory founder conversation with timing choices, not a paid scope.',
      'Base and Partner also moved on June 14, but they still have not named the actual client, deliverable mix, budget, or timing beyond "a rising AI company" and a seed-user push.',
      'Keep both in email until the ask can be described in one sentence with company, deliverable, timing, and owner.',
      'Do not create a Robert brief from a promising intro, a category story, or a request for the rate card alone.',
    ],
  },
];
